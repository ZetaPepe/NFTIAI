            ...
            >
              {!isWalletConnected ? (
                ...
                >
                  ...
                  <span className="relative z-10 sm:hidden">{isConnecting ? "..." : "WALLET"}</span>
                  <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity"></span>
                </button>
              ) : (
          ...
          >
            ...
            >
              <button
                ...
                className="px-4 sm:px-6 py-2 bg-[#a3ff12] text-black font-bold hover:bg-opacity-90 transition-all relative group overflow-hidden text-sm sm:text-base"
              >
                <span className="relative z-10">TOKENIZE AI IP</span>
                <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity"></span>
              ...
              <button
                ...
                className="px-4 sm:px-6 py-2 border border-[#a3ff12] gradient-text font-bold hover:bg-[#a3ff12] hover:bg-opacity-10 transition-all relative group overflow-hidden text-sm sm:text-base"
              >
                <span className="relative z-10">EXPLORE SOLANA RWA</span>
                ...
                <button
                  ...
                  className={`px-3 py-2 text-sm font-semibold transition-all relative overflow-hidden group ${
                    selectedCategory === category
                      ...
                      : "border border-[#a3ff12] gradient-text hover:bg-[#a3ff12] hover:bg-opacity-10"
                  }`}
                >
        ...
        <section id="rwa-bridge" className="mb-24">
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-2xl font-bold gradient-text">WHAT ARE REAL WORLD ASSETS (RWA)?</h2>
                <div className="space-y-4 text-gray-300">
                  <p>
                    Real World Assets (RWA) represent tangible or intangible assets that exist outside the blockchain
                    but are tokenized as digital representations. In the context of NFTI AI, RWAs include:
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-3">
                      <span className="text-[#a3ff12] font-bold">•</span>
                      <span>AI Models and Neural Networks</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-[#a3ff12] font-bold">•</span>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-[#a3ff12] font-bold">•</span>
                      <span>Training Datasets and Data Rights</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-[#a3ff12] font-bold">•</span>
                      <span>AI Patents and Intellectual Property</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-[#a3ff12] font-bold">•</span>
                      <span>Research Papers and Methodologies</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="p-8 bg-black border-2 border-[#a3ff12] shadow-[0_0_20px_#a3ff12]">
                <h3 className="gradient-text font-bold text-xl mb-4">RWA TOKENIZATION STATS</h3>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { label: "AI MODELS TOKENIZED", value: "2,847" },
                    { label: "TOTAL VALUE LOCKED", value: "$12.4M" },
                    { label: "ACTIVE RESEARCHERS", value: "1,291" },
                    { label: "PATENT NFTS", value: "456" },
                  ].map((stat, index) => (
                    <div key={stat.label} className="text-center p-3 border border-[#a3ff12] bg-black bg-opacity-50">
